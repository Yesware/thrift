...
ACLOCAL = ${SHELL} /Users/tjwp/thrift/thrift-0.9.0/missing --run aclocal-1.11
ALLOCA = 
AMTAR = $${TAR-tar}
ANT = /usr/bin/ant
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /Users/tjwp/thrift/thrift-0.9.0/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/tjwp/thrift/thrift-0.9.0/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/tjwp/thrift/thrift-0.9.0/missing --run automake-1.11
AWK = awk
BOOST_CPPFLAGS = -I/usr/local/include
BOOST_LDFLAGS = -L/usr/local/lib
BOOST_ROOT_PATH = /usr/local
BUNDLER = /Users/tjwp/.rvm/gems/ruby-2.0.0-p195/bin/bundle
CABAL = true
...
MAKEINFO = ${SHELL} /Users/tjwp/thrift/thrift-0.9.0/missing --run makeinfo
...
PYTHON_VERSION = 2.7
PY_PREFIX = /usr
QT_CFLAGS = -DQT_SHARED -I/usr/local/Cellar/qt/4.8.2/include -I/usr/local/Cellar/qt/4.8.2/include/QtNetwork -I/usr/local/Cellar/qt/4.8.2/include -I/usr/local/Cellar/qt/4.8.2/include/QtCore 
QT_LIBS = -F/usr/local/Cellar/qt/4.8.2/lib -framework QtNetwork -F/usr/local/Cellar/qt/4.8.2/lib -framework QtCore 
QT_MOC = /usr/local/bin/moc
RAKE = /Users/tjwp/.rvm/gems/ruby-2.0.0-p195@global/bin/rake
RANLIB = ranlib
RUBY = /Users/tjwp/.rvm/rubies/ruby-2.0.0-p195/bin/ruby
RUBY_PREFIX = 
RUNHASKELL = true
SED = /usr/bin/sed
SET_MAKE = 
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /Users/tjwp/thrift/thrift-0.9.0/lib/rb
abs_srcdir = /Users/tjwp/thrift/thrift-0.9.0/lib/rb
abs_top_builddir = /Users/tjwp/thrift/thrift-0.9.0
abs_top_srcdir = /Users/tjwp/thrift/thrift-0.9.0
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Users/tjwp/thrift/thrift-0.9.0/install-sh
